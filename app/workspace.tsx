...
const exerciseLibrary: Exercise[] = [
  { id: "ex-1", name: "Goblet squat", muscle: "Jambes", equipment: "Haltère", level: "Débutant", prescription: "3 × 10 reps", cue: "Genoux dans l’axe, tempo contrôlé", art: "/fitness/athlete-goblet-squat.png" },
  { id: "ex-2", name: "Développé couché", muscle: "Pectoraux", equipment: "Barre", level: "Intermédiaire", prescription: "4 × 8 reps", cue: "Omoplates serrées, trajectoire stable", art: "/fitness/athlete-dumbbell-press.png" },
  { id: "ex-3", name: "Soulevé de terre roumain", muscle: "Ischio-jambiers", equipment: "Barre", level: "Intermédiaire", prescription: "3 × 10 reps", cue: "Hanches en arrière, dos neutre", art: "/fitness/athlete-dumbbell-press.png" },
  { id: "ex-4", name: "Tirage vertical", muscle: "Dos", equipment: "Machine", level: "Débutant", prescription: "3 × 12 reps", cue: "Tirer les coudes vers les côtes", art: "/fitness/athlete-plank-progress.png" },
  { id: "ex-5", name: "Fentes marchées", muscle: "Jambes", equipment: "Poids du corps", level: "Débutant", prescription: "3 × 12 / jambe", cue: "Pousser dans le pied avant", art: "/fitness/athlete-goblet-squat.png" },
...
export function FitFlowWorkspace() {
  ...
  const Programs = () => {
    ...
    return <>
      ...
      <section className="program-visual-hero"><div className="program-visual-copy"><span className="eyebrow">COACHING VISUEL</span><h2>Des séances qui se comprennent en un regard.</h2><p>Chaque programme associe une consigne claire, un mouvement illustré et un indicateur de progression. Une expérience client qui ressemble à un vrai produit fitness.</p><div className="program-visual-pills"><span>✦ Mouvement guidé</span><span>↗ Progression</span><span>✓ Feedback coach</span></div></div><div className="program-visual-art"><div className="program-visual-orbit" /><Image className="program-visual-plank" src="/fitness/athlete-plank-progress.png" alt="Illustration d'une planche active" width={520} height={350} priority /><Image className="program-visual-squat" src="/fitness/athlete-goblet-squat.png" alt="Illustration d'un goblet squat" width={230} height={290} /></div><div className="program-visual-metric"><b>+24%</b><span>régularité moyenne</span></div></section>
